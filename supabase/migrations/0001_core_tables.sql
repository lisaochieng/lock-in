-- ===========================================================
-- lock in — core tables, RLS, and policies
-- -----------------------------------------------------------
-- Idempotent: safe to run multiple times. Paste into the
-- Supabase SQL editor (or run via the CLI) and execute.
--
...
-- ===========================================================
-- Verify: list the tables and whether RLS is enabled
-- ===========================================================
select
